        ...
        <div className="min-h-screen flex flex-col font-sans selection:bg-ds-primary selection:text-white">
            ...
            <main className="flex-1">
                ...
                <section className="relative w-full h-screen">
                    {/* Background Image */}
                    <Image
                        src="/realestate-pics/Image (8).png"
                        alt="Close Concierge Hero"
                        fill
                        className="object-cover"
                        style={{ objectPosition: "calc(50% - 20px) calc(50% + 10px)", top: "-66px" }}
                        quality={100}
                        sizes="100vw"
                        priority
                    />
                    ...
                    <div className="absolute bottom-0 left-0 right-0 h-20 sm:h-28 bg-gradient-to-t from-white to-transparent" />
                </section>
                ...
                <HorizontalScrollSection
                    items={[
                        // 1. Headline
                        {
                            ...
                            subheadline: (
                                <>
                                    <span className="text-[#c2a36b] font-semibold">Not a CRM.</span>{" "}
                                    <span className="text-[#c2a36b] font-semibold">Not an app.</span>{" "}
                                    <span className="text-[#c2a36b] font-semibold">Not more follow-up emails.</span>
                                </>
                            ),
                        },
