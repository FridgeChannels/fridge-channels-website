...
const SOLUTION_SLUG = "exhibition";
      ...
      >
        <div className="mx-auto max-w-[1320px] px-5 md:px-8 lg:px-16">
          ...
          {pricing ? (
            <PilotOfferCard
              title="Pilot Setup"
              subtitle="Start with one event edition. Prove the return path. Then scale across editions."
              showBack={false}
              price={pricing.price}
              ...
              onCheckout={(units) => {
                ...
                console.log("Exhibition pilot units selected:", units);
              }}
            />
          ) : (
