...
import React, { type CSSProperties, type MouseEvent, type ReactNode, useMemo, useState } from "react";
...
const RippleButton: React.FC<RippleButtonProps> = ({
  ...
  // Default variant: keep base styling neutral so consumers fully control colors via className.
  const baseClasses =
