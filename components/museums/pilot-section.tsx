            ...
            >
                <div className="mx-auto max-w-[1320px] px-5 md:px-8 lg:px-16">
                    ...
                    <SinglePricingCard
                        ...
                        benefits={[
                            {
                                text: <strong>50–200 branded magnets (yours to sell and keep)</strong>,
                                icon: Check,
                            },
                            {
                            ...
                            {
                                text: "Content setup (4–6 pieces) — one CTA per tap",
                                icon: Check,
                            },
                            {
                                text: "Real-time dashboard (views, taps, actions)",
                                icon: Check,
                            },
