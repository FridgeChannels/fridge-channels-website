...
const faqItems = [
    {
        id: "faq-1",
        question: "Will visitors buy a magnet?",
        answer: "Museum merch sells. A branded, interactive magnet is a new category — collectible, useful, and smart. It pays for itself.",
    },
    {
        id: "faq-2",
        question: "What makes this different from a normal magnet?",
        answer: "A normal magnet is static decoration. This one is an AI-powered portal — tap it and you're inside a live, personalized experience with your museum's latest exhibits, events, and giving opportunities. The content behind it updates remotely, tracks engagement, and drives real actions. It looks like merch. It works like a channel.",
    },
    {
        id: "faq-3",
        question: "What if no fridge?",
        answer: "Works as a tap card. Keep in wallet or on desk.",
    },
    {
        id: "faq-4",
